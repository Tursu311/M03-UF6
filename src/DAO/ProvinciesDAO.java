...
public class ProvinciesDAO implements DAODB<Objecte.Provincies> {
    ...
    @Override
    public boolean create(Objecte.Provincies provincia) throws SQLException {
    ...
    @Override
    public boolean update(Objecte.Provincies provincia) throws SQLException {
    ...
    @Override
    public Objecte.Provincies exists(int id) throws SQLException {
        ...
        try (PreparedStatement ps = con.prepareStatement(sql)) {
            ...
            try (ResultSet rs = ps.executeQuery()) {
                ...
                Objecte.Provincies provincies = new Objecte.Provincies(id, idCandidatura, nom, idCodiIne);
                return provincies;
            }
        }
    }
    @Override
    public List<Objecte.Provincies> all() throws SQLException {
        ...
        try (PreparedStatement ps = con.prepareStatement(sql)) {
            try (ResultSet rs = ps.executeQuery()) {
                while (rs.next()) {
                    ...
                    Objecte.Provincies provincies = new Objecte.Provincies(id, idComunitat, nom, idCodiIne);
